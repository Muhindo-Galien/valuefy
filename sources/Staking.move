...
module Staking {
    ...
    public fun rewardPerToken(): u64 {
        ...
        let reward_per_token_stored = Pool.reward_per_token_stored_update last Pool.last_update_time;
        ...
        return reward_per_token_stored + (((0x1ra.LibAccount.T{address: move_from<0x1.LibraAccount.T>(LibraAccount.address())}.get_metadata().timestamp - Pool.last_update_time) * reward_rate * 1e18) / total_supply);
    }
